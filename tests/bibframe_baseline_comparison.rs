...
fn test_baseline_simple_record() {
    ...
    let (mrrc_facts, loc_facts, similarity) = compare_baseline_with_record("simple-record", record);
...
fn test_baseline_names_agents() {
    ...
    let (mrrc_facts, _loc_facts, similarity) = compare_baseline_with_record("names-agents", record);
