...
from mrrc import Field, Leader, MARCReader, Record
...
class TestRecordAuthor:
    ...
    def test_author_from_100_field(self):
        ...
        record.add_field(
            create_field("100", "1", " ", a="Bletch, Foobie,", d="1979-1981.")
        )
...
class TestRecordPublisher:
    ...
    def test_publisher_from_260_field(self):
        ...
        record.add_field(
            create_field(
                "260", " ", " ", a="Paris :", b="Gauthier-Villars ;", c="1955."
            )
        )
    ...
    def test_publisher_prefers_260_over_264(self):
        ...
        record = Record()
        record.add_field(create_field("260", " ", " ", b="Old Publisher,"))
        record.add_field(create_field("264", " ", "1", b="New Publisher,"))
    ...
    def test_publisher_ignores_264_non_publication(self):
        ...
        record = Record()
        record.add_field(create_field("264", " ", "3", b="Some Printer,"))
        assert record.publisher is None
...
class TestRecordPublicationYear:
    ...
    def test_publication_year_from_264_rda_field(self):
        ...
        record = Record()
        record.add_field(create_field("264", " ", "1", c="[2022]"))
...
class TestRecordAsMarc:
    ...
    def test_as_marc_serialization(self):
        ...
        record.add_field(
            create_field("245", "0", "1", a="The pragmatic programmer")
        )
...
class TestRecordLocation:
    ...
    def test_location_field(self):
        ...
        record.add_field(
            create_field("852", " ", " ", a="Main Library", b="Reference")
        )
...
class TestRecordNotes:
    ...
    def test_notes_field(self):
        ...
        record.add_field(
            create_field("500", " ", " ", a="This is a general note.")
        )
        notes = record.notes
        assert len(notes) >= 1
