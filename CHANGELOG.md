...
- **`SubfieldValueQuery` negation flag** ([#64](https://github.com/dchud/mrrc/issues/64)): `SubfieldValueQuery("650", "a", "History", negate=True)` pushes value inversion into Rust. Works with both exact and partial matching.
