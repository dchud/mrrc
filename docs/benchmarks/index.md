...
On a realistic corpus the Python wrapper reads substantially faster than pymarc
— both per record and, further, through the parallel batch path — and the
native Rust crate is faster still. See [Results](results.md) for the measured
three-way figures and how to benchmark mrrc on your own hardware and data.
