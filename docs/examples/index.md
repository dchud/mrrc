...
| Example | Python | Rust | Description |
|---------|--------|------|-------------|
| DuckDB Queries | [duckdb_queries.py] | - | SQL queries on Arrow data |
| Polars DataFrames | [polars_dataframes.py] | [polars_arrow_eval.rs] | DataFrame operations |
| Format Conversions | [format_conversions.py] | - | Multiple format workflows |
...
cargo run --example marc_to_bibframe --features format-bibframe
...
[duckdb_queries.py]: https://github.com/dchud/mrrc/blob/main/examples/python/duckdb_queries.py
[polars_dataframes.py]: https://github.com/dchud/mrrc/blob/main/examples/python/polars_dataframes.py
[polars_arrow_eval.rs]: https://github.com/dchud/mrrc/blob/main/examples/polars_arrow_eval.rs
[format_conversions.py]: https://github.com/dchud/mrrc/blob/main/examples/python/format_conversions.py
