...
### ProtobufReader / ProtobufWriter

Protocol Buffers format for APIs and IPC.
...
### MessagePackReader / MessagePackWriter
...
### FlatbuffersReader / FlatbuffersWriter

Zero-copy format for memory-efficient access.
