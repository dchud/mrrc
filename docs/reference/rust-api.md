...
Convert MARC to BIBFRAME 2.0 RDF (`format-bibframe` feature):
...
| Feature | Description |
|---------|-------------|
| `format-protobuf` | Protocol Buffers support |
| `format-arrow` | Apache Arrow support |
| `format-flatbuffers` | FlatBuffers support |
| `format-messagepack` | MessagePack support |
| `format-bibframe` | BIBFRAME conversion |
