...
# Each entry: (filename, description, mutation-producing function).
# When a fixture's filename starts with `e0xx_` the leading code links
# back to the matching `[[case]]` in tests/error_coverage.toml.
