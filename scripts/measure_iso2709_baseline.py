...
- **Commit:** {subprocess.check_output(['git', 'rev-parse', 'HEAD']).decode().strip()[:7] if subprocess.run(['git', 'rev-parse', 'HEAD'], capture_output=True, cwd='/Users/dchud/Documents/projects/mrrc').returncode == 0 else 'N/A'}
