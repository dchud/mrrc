...
# EndOfRecordNotFound, FieldNotFound, FatalReaderError) preserve pymarc's
# names and parent relationships. mrrc-specific subclasses (InvalidIndicator,
...
#   record_index, record_control_number, field_tag, indicator_position,
#   subfield_code, found, expected, byte_offset, record_byte_offset, source.
# Every kwarg is optional so bare-constructor compatibility is preserved
# (e.g., `raise RecordLeaderInvalid()` still works).
