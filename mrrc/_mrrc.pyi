...
# =============================================================================
# Tier 1 Format: Protobuf
# =============================================================================

class ProtobufReader:
    """Reader for MARC records in Protocol Buffers format."""
    def __init__(self, source: Union[str, bytes]) -> None: ...
    def __iter__(self) -> Iterator[Record]: ...
    def __next__(self) -> Record: ...
    def read_record(self) -> Optional[Record]: ...
    def records_read(self) -> Optional[int]: ...

class ProtobufWriter:
    """Writer for MARC records in Protocol Buffers format."""
    def __init__(self, path: Optional[str] = None) -> None: ...
    def write_record(self, record: Record) -> None: ...
    def write(self, record: Record) -> None: ...
    def get_bytes(self) -> bytes: ...
    def close(self) -> None: ...
    def records_written(self) -> Optional[int]: ...
    def __enter__(self) -> ProtobufWriter: ...
    def __exit__(self, exc_type: Any, exc_val: Any, exc_tb: Any) -> bool: ...

def record_to_protobuf(record: Record) -> bytes: ...
def protobuf_to_record(data: bytes) -> Record: ...
...
class ArrowReader:
    """Reader for MARC records in Apache Arrow IPC format."""
    def __init__(self, source: Union[str, bytes]) -> None: ...
    def __iter__(self) -> Iterator[Record]: ...
    def __next__(self) -> Record: ...
    def read_record(self) -> Optional[Record]: ...
...
class ArrowWriter:
    """Writer for MARC records in Apache Arrow IPC format."""
    def __init__(self, path: Optional[str] = None) -> None: ...
    def write_record(self, record: Record) -> None: ...
    def write(self, record: Record) -> None: ...
    def get_bytes(self) -> bytes: ...
...
# =============================================================================
# Tier 2 Format: FlatBuffers
# =============================================================================

class FlatbuffersReader:
    """Reader for MARC records in FlatBuffers format."""
    def __init__(self, source: Union[str, bytes]) -> None: ...
    def __iter__(self) -> Iterator[Record]: ...
    def __next__(self) -> Record: ...
    def read_record(self) -> Optional[Record]: ...
...
class FlatbuffersWriter:
    """Writer for MARC records in FlatBuffers format."""
    def __init__(self, path: Optional[str] = None) -> None: ...
    def write_record(self, record: Record) -> None: ...
    def write(self, record: Record) -> None: ...
    def get_bytes(self) -> bytes: ...
    def close(self) -> None: ...
    def records_written(self) -> Optional[int]: ...
    def __enter__(self) -> FlatbuffersWriter: ...
    def __exit__(self, exc_type: Any, exc_val: Any, exc_tb: Any) -> bool: ...

def record_to_flatbuffers(record: Record) -> bytes: ...
def flatbuffers_to_record(data: bytes) -> Record: ...

# =============================================================================
# Tier 2 Format: MessagePack
# =============================================================================

class MessagePackReader:
    """Reader for MARC records in MessagePack format."""
    def __init__(self, source: Union[str, bytes]) -> None: ...
    def __iter__(self) -> Iterator[Record]: ...
    def __next__(self) -> Record: ...
    def read_record(self) -> Optional[Record]: ...
...
class MessagePackWriter:
    """Writer for MARC records in MessagePack format."""
    def __init__(self, path: Optional[str] = None) -> None: ...
    def write_record(self, record: Record) -> None: ...
    def write(self, record: Record) -> None: ...
    def get_bytes(self) -> bytes: ...
    def close(self) -> None: ...
    def records_written(self) -> Optional[int]: ...
    def __enter__(self) -> MessagePackWriter: ...
    def __exit__(self, exc_type: Any, exc_val: Any, exc_tb: Any) -> bool: ...

def record_to_messagepack(record: Record) -> bytes: ...
def messagepack_to_record(data: bytes) -> Record: ...
