...
from typing import Iterator, Optional, List, Any, final
...
class Leader:
    ...
    @staticmethod
    def get_value_description(position: int, value: str) -> Optional[str]: ...
...
class Field:
    ...
    def __new__(cls, tag: str, indicator1: Optional[str] = None, indicator2: Optional[str] = None, *, subfields: list[Subfield] | None = None, indicators: list[str] | None = None) -> Field: ...
    def __repr__(self) -> str: ...
    def __str__(self) -> str: ...
    def __eq__(self, other: object, /) -> bool: ...
...
class AuthorityRecord:
    ...
    def record_type(self) -> str:
        ...
        ...
    def heading(self) -> Optional[Field]:
    ...
    def linking_entries(self) -> List[Field]:
        ...
        ...
    def get_fields(self, tag: str) -> Optional[List[Field]]:
...
class FieldQuery:
    ...
    def indicator1(self, indicator: Optional[str] = None) -> FieldQuery: ...
    def indicator2(self, indicator: Optional[str] = None) -> FieldQuery: ...
...
class TagRangeQuery:
    ...
    @property
    def indicator1(self) -> Optional[str]: ...
    @property
    def indicator2(self) -> Optional[str]: ...
    def tag_in_range(self, tag: str) -> bool: ...

@final
class SubfieldPatternQuery:
    """Query for fields where a subfield matches a regex pattern."""
    def __new__(cls, tag: str, subfield_code: str, pattern: str, *, negate: bool = False) -> SubfieldPatternQuery: ...
    @property
    def tag(self) -> str: ...
    @property
...
class SubfieldValueQuery:
    ...
    def __new__(
        cls, tag: str, subfield_code: str, value: str, *, partial: bool = False, negate: bool = False
    ) -> SubfieldValueQuery: ...
    @property
    def tag(self) -> str: ...
    @property
...
class MARCWriter:
    ...
    def __exit__(self, _exc_type: Any = None, _exc_val: Any = None, _exc_tb: Any = None) -> bool: ...
...
class AuthorityMARCReader:
    ...
    def read_record(self) -> Optional[AuthorityRecord]: ...
...
class HoldingsMARCReader:
    ...
    def __exit__(self, _exc_type: Any, _exc_val: Any, _exc_tb: Any) -> bool: ...
    def read_record(self) -> Optional[HoldingsRecord]: ...
...
class ProducerConsumerPipeline:
    ...
    def try_next(self) -> Optional[Record]: ...
