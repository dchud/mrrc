...
class Leader:
    ...
    def __str__(self) -> str: ...
    def __eq__(self, other: object, /) -> bool: ...
    def __deepcopy__(self, _memo: object) -> Leader: ...
    @staticmethod
...
class Field:
    ...
    def __str__(self) -> str: ...
    def __eq__(self, other: object, /) -> bool: ...
    def __deepcopy__(self, _memo: object) -> Field: ...
...
class Record:
    ...
    def __str__(self) -> str: ...
    def __eq__(self, other: object, /) -> bool: ...
    def __deepcopy__(self, _memo: object) -> Record: ...
    @property
    ...
    def field_at(self, tag: str, occurrence: int) -> Field | None:
        ...
        ...
    def replace_field_at(
        self, tag: str, occurrence: int, field: Field
    ) -> bool:
    ...
    def control_field_value_at(self, tag: str, occurrence: int) -> str | None:
        ...
        ...
    def set_control_field_value_at(
        self, tag: str, occurrence: int, value: str
    ) -> bool:
