...
- Rust-core parsing with GIL release for multi-threaded Python workloads — roughly 8× pymarc on per-record reads and ~35× on the parallel bulk path in a recent single-host comparison ([benchmarks](docs/benchmarks/))
