...
class Field:
    ...
    def __new__(cls, tag: str, indicator1: str = " ", indicator2: str = " ", *, subfields: list[Subfield] | None = None, indicators: list[str] | None = None) -> Field: ...
    def __repr__(self) -> str: ...
    def __str__(self) -> str: ...
    def __eq__(self, other: object) -> bool: ...
    @property
...
class Record:
    ...
    def __new__(cls, leader: Leader, *, fields: list[Field] | None = None) -> Record: ...
    def __repr__(self) -> str: ...
    def __str__(self) -> str: ...
    def __eq__(self, other: object) -> bool: ...
