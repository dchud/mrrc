...
use crate::define_field_accessors;
...
impl HoldingsRecord {
    ...
    // Field accessor methods generated by macro

    define_field_accessors!(locations, add_location, locations);
    define_field_accessors!(captions_basic, add_captions_basic, captions_basic);
    define_field_accessors!(
        captions_supplements,
        add_captions_supplements,
        captions_supplements
    );
    define_field_accessors!(captions_indexes, add_captions_indexes, captions_indexes);
    define_field_accessors!(enumeration_basic, add_enumeration_basic, enumeration_basic);
    define_field_accessors!(
        enumeration_supplements,
        add_enumeration_supplements,
        enumeration_supplements
    );
    define_field_accessors!(
        enumeration_indexes,
        add_enumeration_indexes,
        enumeration_indexes
    );
    define_field_accessors!(
        textual_holdings_basic,
        add_textual_holdings_basic,
        textual_holdings_basic
    );
    define_field_accessors!(
        textual_holdings_supplements,
        add_textual_holdings_supplements,
        textual_holdings_supplements
    );
    define_field_accessors!(
        textual_holdings_indexes,
        add_textual_holdings_indexes,
        textual_holdings_indexes
    );
