...
pub struct HoldingsRecord {
    ...
    /// Location and call number information (852)
    pub locations: Vec<Field>,
    /// Captions and pattern for basic units (853)
    pub captions_basic: Vec<Field>,
    /// Captions and pattern for supplements (854)
    pub captions_supplements: Vec<Field>,
    /// Captions and pattern for indexes (855)
    pub captions_indexes: Vec<Field>,
    /// Enumeration and chronology for basic units (863)
    pub enumeration_basic: Vec<Field>,
    /// Enumeration and chronology for supplements (864)
    pub enumeration_supplements: Vec<Field>,
    /// Enumeration and chronology for indexes (865)
    pub enumeration_indexes: Vec<Field>,
    /// Textual holdings for basic units (866)
    pub textual_holdings_basic: Vec<Field>,
    /// Textual holdings for supplements (867)
    pub textual_holdings_supplements: Vec<Field>,
    /// Textual holdings for indexes (868)
    pub textual_holdings_indexes: Vec<Field>,
    /// Item information (876-878)
    pub item_information: BTreeMap<String, Vec<Field>>,
...
impl HoldingsRecord {
    ...
    pub fn new(leader: Leader) -> Self {
        HoldingsRecord {
            ...
            locations: Vec::new(),
            captions_basic: Vec::new(),
            captions_supplements: Vec::new(),
            captions_indexes: Vec::new(),
            enumeration_basic: Vec::new(),
            enumeration_supplements: Vec::new(),
            enumeration_indexes: Vec::new(),
            textual_holdings_basic: Vec::new(),
            textual_holdings_supplements: Vec::new(),
            textual_holdings_indexes: Vec::new(),
            item_information: BTreeMap::new(),
    ...
    pub fn add_captions_basic(&mut self, field: Field) {
        self.captions_basic.push(field);
    }

    /// Get all captions fields for basic units (853)
    #[must_use]
    ...
    pub fn add_captions_supplements(&mut self, field: Field) {
        self.captions_supplements.push(field);
    }

    /// Get all captions fields for supplements (854)
    #[must_use]
    ...
    pub fn add_captions_indexes(&mut self, field: Field) {
        self.captions_indexes.push(field);
    }

    /// Get all captions fields for indexes (855)
    #[must_use]
    ...
    pub fn add_enumeration_basic(&mut self, field: Field) {
        self.enumeration_basic.push(field);
    }

    /// Get all enumeration fields for basic units (863)
    #[must_use]
    ...
    pub fn add_enumeration_supplements(&mut self, field: Field) {
        self.enumeration_supplements.push(field);
    }

    /// Get all enumeration fields for supplements (864)
    #[must_use]
    ...
    pub fn add_enumeration_indexes(&mut self, field: Field) {
        self.enumeration_indexes.push(field);
    }

    /// Get all enumeration fields for indexes (865)
    #[must_use]
    ...
    pub fn add_textual_holdings_basic(&mut self, field: Field) {
        self.textual_holdings_basic.push(field);
    }

    /// Get all textual holdings fields for basic units (866)
    #[must_use]
    pub fn textual_holdings_basic(&self) -> &[Field] {
        &self.textual_holdings_basic
    }

    /// Add a textual holdings field for supplements (867)
    pub fn add_textual_holdings_supplements(&mut self, field: Field) {
        self.textual_holdings_supplements.push(field);
    }

    /// Get all textual holdings fields for supplements (867)
    #[must_use]
    pub fn textual_holdings_supplements(&self) -> &[Field] {
        &self.textual_holdings_supplements
    }

    /// Add a textual holdings field for indexes (868)
    pub fn add_textual_holdings_indexes(&mut self, field: Field) {
        self.textual_holdings_indexes.push(field);
    }

    /// Get all textual holdings fields for indexes (868)
    #[must_use]
    pub fn textual_holdings_indexes(&self) -> &[Field] {
        &self.textual_holdings_indexes
    }
    ...
    pub fn get_item_information(&self, tag: &str) -> Option<&[Field]> {
        self.item_information.get(tag).map(Vec::as_slice)
    }
