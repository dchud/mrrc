...
impl<W: Write> HoldingsMarcWriter<W> {
    ...
    pub fn write_record(&mut self, record: &HoldingsRecord) -> Result<()> {
        ...
        // Write location fields (852)
        for field in &record.locations {
            add_field(
                &field.tag,
        ...
        // Write captions and pattern fields (853-855)
        for field in &record.captions_basic {
            add_field(
                &field.tag,
                Some((field.indicator1, field.indicator2)),
                None,
        ...
        for field in &record.captions_supplements {
            add_field(
                &field.tag,
                Some((field.indicator1, field.indicator2)),
                None,
        ...
        for field in &record.captions_indexes {
            add_field(
                &field.tag,
                Some((field.indicator1, field.indicator2)),
                None,
        ...
        // Write enumeration and chronology fields (863-865)
        for field in &record.enumeration_basic {
            add_field(
                &field.tag,
                Some((field.indicator1, field.indicator2)),
                None,
        ...
        for field in &record.enumeration_supplements {
            add_field(
                &field.tag,
                Some((field.indicator1, field.indicator2)),
                None,
        ...
        for field in &record.enumeration_indexes {
            add_field(
                &field.tag,
                Some((field.indicator1, field.indicator2)),
                None,
        ...
        // Write textual holdings fields (866-868)
        for field in &record.textual_holdings_basic {
            add_field(
                &field.tag,
                Some((field.indicator1, field.indicator2)),
                None,
        ...
        for field in &record.textual_holdings_supplements {
            add_field(
                &field.tag,
                Some((field.indicator1, field.indicator2)),
                None,
        ...
        for field in &record.textual_holdings_indexes {
            add_field(
                &field.tag,
                Some((field.indicator1, field.indicator2)),
                None,
